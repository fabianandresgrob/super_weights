...
class UniversalLayerHandler:
    ...
    def _detect_attention_architecture(self, attention_module: nn.Module) -> AttentionArchitectureInfo:
        ...
        # Detect attention type and parameters
        num_heads = getattr(attention_module, 'num_heads', 32)
        ...
        hidden_size = getattr(attention_module, 'hidden_size', 4096)
        
        if head_dim is None and 'q_proj' in components:
            head_dim = components['q_proj'].weight_shape[0] // num_heads
        ...
        return AttentionArchitectureInfo(
            ...
            rope_theta=getattr(attention_module, 'rope_theta', None)
        )
